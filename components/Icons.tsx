...
export const IconBrainCircuit: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 5a3 3 0 1 0-5.993.142"/><path d="M18 5a3 3 0 1 0-5.993.142"/><path d="M12 12a3 3 0 1 0-5.993.142"/><path d="M18 12a3 3 0 1 0-5.993.142"/><path d="M12 19a3 3 0 1 0-5.993.142"/><path d="M18 19a3 3 0 1 0-5.993.142"/><path d="M12 5a3 3 0 1 0 5.993.142"/><path d="M18 5a3 3 0 1 0 5.993.142"/><path d="M12 12a3 3 0 1 0 5.993.142"/><path d="M18 12a3 3 0 1 0 5.993.142"/><path d="M12 19a3 3 0 1 0 5.993.142"/><path d="M18 19a3 3 0 1 0 5.993.142"/><path d="M6 5v0"/><path d="M6 12v0"/><path d="M6 19v0"/><path d="M18 5v0"/><path d="M18 12v0"/><path d="M18 19v0"/><path d="m15.5 6.5-2.5 4"/><path d="m15.5 13.5-2.5 4"/><path d="m8.5 6.5 2.5 4"/><path d="m8.5 13.5 2.5 4"/></svg>
);
